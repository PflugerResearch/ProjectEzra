...
import type { Scenario } from '../../../data/projects/massTimberData';
...
export default function ScenarioBarChart({ scenarios, baseTotal }: ScenarioBarChartProps) {
  ...
  const getBarColor = (scenario: Scenario) => {
        ...
        <div className="inline-flex rounded-lg bg-gray-100 p-1">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${
              !showCostPerSF ? 'bg-white shadow text-gray-900' : 'text-gray-500'
            }`}
          >
            Total Cost
          </button>
              ...
              <div className="h-10 bg-gray-100 rounded-lg overflow-hidden relative">
                ...
                {index > 0 && (
                  <motion.div
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 text-xs font-medium text-white bg-black/50 px-2 py-1 rounded"
                  >
