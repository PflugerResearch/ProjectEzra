...
import type { Alternate } from '../../../data/projects/massTimberData';

interface AlternatesBuilderProps {
  alternates: Alternate[];
  baseTotal: number;
  area: number;
}

export default function AlternatesBuilder({ alternates, baseTotal, area }: AlternatesBuilderProps) {
  ...
  return (
    <div className="w-full">
      {/* Total Display */}
      <motion.div
        className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-6 mb-8 text-white"
        layout
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <div className="flex gap-6">
            <div>
              ...
              <p className="text-xl font-semibold">${costPerSF.toFixed(2)}/SF</p>
            </div>
            <div>
